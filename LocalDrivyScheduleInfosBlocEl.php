 ...
 * @since 1.0.0
 */
class LocalDrivyScheduleInfosBlocEl extends \Elementor\Widget_Base
{
    ...
    protected function render()
    {
        ...
        $html = $localDrivyApiClient->getScheduleInfos();
        $style="";
        if ($title_color!=null) {
